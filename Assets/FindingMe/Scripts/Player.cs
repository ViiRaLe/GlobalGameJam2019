...
public class Player : MonoBehaviour
{
    ...
    private float jumpAudioVolume = 0.2f;

    [SerializeField]
    private AudioClip bumpAudioClip;
    private float bumpAudioVolume = 0.2f;

    [SerializeField]
    private AudioClip deathAudioClip;
    private float deathAudioVolume = 0.2f;

    [SerializeField]
    private AudioClip powerupAudioClip;
    private float powerupAudioVolume = 0.2f;
    ...
    private void Start()
    {
        ...
        baseGravity = fakeGravity;
        maxJumpVelocity = Mathf.Abs(fakeGravity) * timeToJumpApex;
        minJumpVelocity = Mathf.Sqrt(2 * Mathf.Abs(fakeGravity) * minJumpHeight);
        walkSpeed = moveSpeed;
    ...
    private void CalculateVelocity()
    {
        ...
        velocity.y += fakeGravity * Time.deltaTime;
    }
